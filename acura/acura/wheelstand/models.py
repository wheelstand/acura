...
#    name = models.CharField(max_length=255, null=True, blank=True,)
    horsePower = models.CharField(max_length=255, null=True, blank=True, verbose_name='Horsepower')
    ...
    compressionRatio = models.CharField(max_length=255, null=True, blank=True, verbose_name="Compression Ratio")
    ...
    engine_en = models.CharField(max_length=255, verbose_name=_('Engine English'), help_text=_('English'), null=True, blank=True)
    engine_fr = models.CharField(max_length=255, verbose_name=_('Engine French'), help_text=_('French'), null=True, blank=True)
