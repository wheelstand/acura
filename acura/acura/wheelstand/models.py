...
class Models(models.Model):
	...
	line9_en = models.CharField(max_length=255, blank=True,
	                            null=True, help_text=_('English'), verbose_name="Line 9 English", default='')
	line9_fr = models.CharField(max_length=255, blank=True,
	                            null=True, help_text=_('French'), verbose_name="Line 9 French", default='')
	...
	line17_en = models.CharField(max_length=255, blank=True,
	                             null=True, help_text=_('English'), verbose_name="Line 8 English", default='')
	line17_fr = models.CharField(max_length=255, blank=True,
	                             null=True, help_text=_('French'), verbose_name="Line 8 French", default='')
	line17_city = models.CharField(max_length=255, blank=True,
	                               null=True, help_text=_('City'), verbose_name="Line 8 City", choices=choices.CITIES)
	line18_en = models.CharField(max_length=255, blank=True,
	                             null=True, help_text=_('English'), verbose_name="Line 9 English", default='')
	line18_fr = models.CharField(max_length=255, blank=True,
	                             null=True, help_text=_('French'), verbose_name="Line 9 French", default='')
	line18_city = models.CharField(max_length=255, blank=True,
	                               null=True, help_text=_('City'), verbose_name="Line 9 City", choices=choices.CITIES)
...
class Transmission(models.Model):
	trim_tranmission = models.ForeignKey('Trim', blank=True, null=True, related_name='transmissions')
...
class Trim(models.Model):
	...
	features_en = models.TextField(max_length=2000, help_text=_('English'), verbose_name="Features English", null=True,
	                               blank=True, )
...
class ModelsShown(models.Model):
	...
	transmission_fr = models.CharField(max_length=4, choices=choices.TRANSMISSIONS_FR, null=True, blank=True)
	...
	md5 = models.CharField(default=random_string(), max_length=255, editable=False)
	status_changed = MonitorField(monitor='url', editable=False)
	models_shown_price = models.CharField(max_length=255, null=True, blank=True)
...
class Location(models.Model):
	...
	description_en = models.TextField(max_length=2500, null=True,
	                                  blank=True, help_text=_('English'),
	                                  verbose_name="Description English")
	description_fr = models.TextField(max_length=2500, null=True, blank=True,
...
class Interiors(models.Model):
	...
	url = models.ImageField(upload_to='uploads/interiors/', null=True, blank=True, verbose_name=_('Image'), default='')
	link = models.CharField(max_length=255, null=True, blank=True, verbose_name=_('OR Remote URL'))
	md5 = models.CharField(default=random_string(), max_length=255, editable=False)
	status_changed = MonitorField(monitor='url', editable=False)
...
class Engines(models.Model):
	...
	horsePower_en = models.CharField(max_length=255, null=True, blank=True, verbose_name='Horsepower First')
	horsePower_fr = models.CharField(max_length=255, null=True, blank=True, verbose_name='Horsepower Last')
	...
	compressionRatio_en = models.CharField(max_length=255, null=True, blank=True, help_text=_('French'),
	                                       verbose_name="Compression Ratio")
	compressionRatio_fr = models.CharField(max_length=255, null=True, blank=True, help_text=_('French'),
	                                       verbose_name=_('Compression Raio French'))
	driveByWire = models.BooleanField(max_length=255, verbose_name=_('Drive-by-Wire Throttle System'), default=False,
	                                  blank=True)
	ecoAssis = models.BooleanField(max_length=255, default=False, blank=True)
	...
	hyBridPowerTrain = models.CharField(max_length=255, null=True, blank=True, verbose_name='Hybrid Powertrain')
	hybridHorsePower = models.CharField(max_length=255, null=True, blank=True, verbose_name='Hybrid Horsepower')
	hybridTorque = models.CharField(max_length=255, null=True, blank=True, verbose_name='Hybrid Torque')
	activeControl = models.CharField(max_length=255, null=True, blank=True, verbose_name='Active Control')
	idelStop = models.CharField(max_length=255, null=True, blank=True, verbose_name='Idle Stop')
	vcm = models.CharField(max_length=255, null=True, blank=True, verbose_name='VCM')

	engine_en = models.CharField(max_length=255, verbose_name=_('Engine English'), help_text=_('English'), null=True,
	                             blank=True)
	engine_fr = models.CharField(max_length=255, verbose_name=_('Engine French'), help_text=_('French'), null=True,
	                             blank=True)
	horsePowerLast_en = models.CharField(max_length=255, null=True, blank=True, verbose_name='Torque First')
	horsePowerLast_fr = models.CharField(max_length=255, null=True, blank=True, verbose_name='Torque Last')
	...
	def __unicode__(self):
		...
		self.name_en, self.displacement, self.horsePower_en, self.horsePower_fr, self.horsePowerLast_en,
		self.horsePowerLast_fr)
	...
	def compressionRatio(self):
		return {
			'en': self.compressionRatio_en,
			'fr': self.compressionRatio_fr
		}
	...
	#        return {
	#            'first': {
	#                'en': self.horsePower_en,
	#                'fr': self.horsePower_fr
	#            },'last': {
	#                'en': self.horsePowerLast_en,
	#                'fr': self.horsePowerLast_fr
	#            }
	#        }
	...
	def horsePower(self):
		return {
			'first': self.horsePower_en,
			'last': self.horsePower_fr
		}

	@property
	def torque(self):
		return {
			'first': self.horsePowerLast_en,
			'last': self.horsePowerLast_fr
		}
...
class InteriorColour(models.Model):
	...
	#    colour = ColorField(default='#FFFFFF', null=True, blank=True)
	selected = models.BooleanField(default=False)
