...
class ModelsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Models
        fields = ('id', 'trims', 'name', 'year', 'subhead', 'url', 'path', 'link', 'disclaimer', 'base_price', 'freight_DPI', 'special_offers', 'line1', 'line2', 'percentage', 'price')
        depth = 1
...
class ModelsShownSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ModelsShown
        fields = ('id', 'vehicle', 'trim', 'wheels', 'drivetrain', 'accessory', 'price_override', 'location')
