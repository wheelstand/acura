...
class EnginesSerializer(serializers.ModelSerializer):
    class Meta:
        model = Engines
        fields = ('id', 'name', 'engine', 'hyBridPowerTrain', 'horsePower', 'torque', 'hybridHorsePower', 'hybridTorque', 'displacement', 'boreAndStroke', 'emissions', 'activeControl', 'idelStop', 'compressionRatio',  'vcm', 'recommendedFuel')
