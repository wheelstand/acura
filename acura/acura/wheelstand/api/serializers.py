...
class EnginesSerializer(serializers.ModelSerializer):
	class Meta:
		model = Engines
		fields = (
		'id', 'name', 'engine', 'hyBridPowerTrain', 'horsePower', 'torque', 'hybridHorsePower', 'hybridTorque',
		'displacement', 'boreAndStroke', 'emissions', 'activeControl', 'idelStop', 'compressionRatio', 'vcm',
		'recommendedFuel')
...
class InteriorColourSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ('id', 'name', 'url', 'path', 'selected')
...
class ExteriorColourSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ('id', 'name', 'colour', 'url', 'path', 'selected', 'interior_colour')
...
class TrimNSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ('id', 'name', 'order', 'model', 'base_price', 'engine', 'transmissions', 'features', 'highlights',
		          'exteriorColours', 'interiorColours', 'url', 'path', 'link', 'heading', 'description', 'interiors')
		extra_kwargs = {
			'url': {
				'required': False,
			}
...
class ModelsSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		'special_offers', 'line1', 'line2', 'line3', 'line4', 'line5', 'line6', 'line7', 'line8', 'line9', 'line10',
		'line10_city', 'line11', 'line11_city', 'line12', 'line12_city', 'line13', 'line13_city', 'line14',
		'line14_city', 'line15', 'line15_city', 'line16', 'line16_city', 'line17', 'line17_city', 'line18',
		'line18_city', 'percentage', 'price', 'gallery', 'overview_image_text')
		#        fields = '__all__'
		depth = 1
...
class TrimSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		'interiorColours', 'url', 'path', 'link', 'heading', 'description', 'interiors')
		extra_kwargs = {
			'url': {
				'required': False,
			},
...
class ModelsShownSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = ModelsShown
		fields = (
		'id', 'models_shown_price', 'vehicle', 'trim', 'url', 'path', 'link', 'disclaimer', 'wheels', 'drivetrain',
		'accessory', 'price_override', 'location', 'fuel_city', 'fuel_highway', 'fuel_combined', 'transmissions',
		'transimissionAbbreviation')
		extra_kwargs = {
			'url': {
				'required': False,
			}
