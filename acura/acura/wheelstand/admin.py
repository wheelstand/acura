...
class TrimAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ('interiors', 'features', 'transmission')    
    fieldsets = (
        (_('General'), {
...
class ModelsShownAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_('General'), {
            'fields': ('vehicle', 'trim', 'wheels_en', 'wheels_fr', 'drivetrain', 'price_override', ('disclaimer_en', 'disclaimer_fr')),
        }),
...
class EnginesAdmin(admin.ModelAdmin):
    list_display = ('name_en', 'horsePower', 'torque', 'displacement', )
    fieldsets = (
        (_('General'), {
            'fields': (('name_en', 'name_fr',)),
        }),
        (_('Details'), {
            'fields': (('engine_en', 'engine_fr',), 'horsePower', 'torque', 'displacement', ('emissions_en', 'emissions_fr',), ('bore_and_stroke_en', 'bore_and_stroke_fr'), 'compressionRatio', ('recommended_fuel_en', 'recommended_fuel_fr',), 'hyBridPowerTrain', 'hybridHorsePower', 'hybridTorque', 'activeControl', 'idelStop', 'vcm'),
        }),
    )
